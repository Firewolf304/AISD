...
int main() {
    ...
    std::shared_ptr<jhonson<Vertex<std::string, int>, Edge<Vertex<std::string, int>,int, int>>> hamil;
    ...
    hamil = std::make_shared<jhonson<Vertex<std::string, int>, Edge<Vertex<std::string, int>,int, int>>>(grapher);
    while(true) {
        std::cout << "Commands:" << std::endl;
